...
// func findfreqs(num []float64,  den []float64, N int, kind string) error {
//     /*
...
//     } else {
//         return error.new("input must be one of {'ba', 'zp'}")
//     }
// 
//     if len(ep) == 0:
...
// func freqs(b, a, worN=None, plot=None) {
    /*
...
//
//
//func freqs_zpk(z, p, k, worN=None) {
    /*
    Compute frequency response of analog filter.
...
// 
// 
// func freqz(b, a=1, worN=None, whole=False, plot=None) {
    /*
    ...
    a : array_like
        denominator of a linear filter
    worN : {None, int, array_like}, optional
        If None (funcault), then compute at 512 frequencies equally spaced
...
// 
// 
// func freqz_zpk(z, p, k, worN=None, whole=False) {
    /*
...
// 
// 
// func group_delay(system, w=None, whole=False) {
    r/*Compute the group delay of a digital filter.

    The group delay measures by how many samples amplitude envelopes of
    various spectral components of a signal are delayed by a filter.
    It is formally funcined as the derivative of continuous (unwrapped) phase::
    ...
    circle, the group delay at corresponding frequencies is unfuncined.
...
// 
// 
// func sosfreqz(sos, worN=None, whole=False) {
    /*
...
// func _cplxreal(z, tol=None) {
    ...
    tol : float, optional
        ...
        funcault is ``100 * spacing(1)`` of `z`'s data type (i.e. 2e-14 for
        float64)
...
// 
// 
// func tf2sos(b, a, pairing='nearest') {
    /*
...
// 
// 
// func _nearest_real_complex_idx(fro, to, which) {
...
// 
// 
// func zpk2sos(z, p, k, pairing='nearest') {
//     /*
...
// 
//     With ``pairing='nearest'`` (the funcault), we obtain
// 
...
// 
// 
// func iirdesign(wp, ws, gpass, gstop, analog=False, ftype='ellip', output='ba') {
...
//         second-order sections ('sos'). funcault is 'ba'.
// 
//     Returns
//     -------
//     b, a : ndarray, ndarray
...
// 
// 
// func iirfilter(N, Wn, rp=None, rs=None, btype='band', analog=False,
...
//         The type of filter.  funcault is 'bandpass'.
//     analog : bool, optional
//         When True, return an analog filter, otherwise a digital filter is
//         returned.
//     ftype : str, optional
...
// 
// 
// func _zpklp2bp(z, p, k, wo=1.0, bw=1.0) {
//     r/*
//     Transform a lowpass filter prototype to a bandpass filter.
// 
//     Return an analog band-pass filter with center frequency `wo` and
...
// 
// 
// func _zpklp2bs(z, p, k, wo=1.0, bw=1.0) {
//     r/*
//     Transform a lowpass filter prototype to a bandstop filter.
// 
//     Return an analog band-stop filter with center frequency `wo` and
...
// 
// 
// func butter(N, Wn, btype='low', analog=False, output='ba') {
//     /*
...
//         The type of filter.  funcault is 'lowpass'.
//     analog : bool, optional
//         When True, return an analog filter, otherwise a digital filter is
//         returned.
//     output : {'ba', 'zpk', 'sos'}, optional
...
// 
// 
// func cheby1(N, rp, Wn, btype='low', analog=False, output='ba') {
//     /*
...
// 
// 
// func cheby2(N, rs, Wn, btype='low', analog=False, output='ba') {
//     /*
...
// 
// 
// func ellip(N, rp, rs, Wn, btype='low', analog=False, output='ba') {
//     /*
...
// 
// 
// func bessel(N, Wn, btype='low', analog=False, output='ba', norm='phase') {
//     /*
...
//         The order of the filter.
//     Wn : array_like
//         A scalar or length-2 sequence giving the critical frequencies (funcined
...
// 
//             This is the funcault, and matches MATLAB's implementation.
// 
//         ``delay``
...
// 
// 
// func band_stop_obj(wp, ind, passb, stopb, gpass, gstop, type) {
//     /*
...
// 
// 
// func cheb2ord(wp, ws, gpass, gstop, analog=False) {
...
// 
// 
// func ellipord(wp, ws, gpass, gstop, analog=False) {
...
//     funcined as the point at which the gain first drops below ``-rp``.
// 
//     See Also
//     --------
...
// 
//     The filter's angular (e.g. rad/s) cutoff frequency is normalized to 1,
//     funcined as the point at which the gain first reaches ``-rs``.
// 
//     See Also
//     --------
...
// 
// 
// func _vratio(u, ineps, mp) {
//     [s, c, d, phi] = special.ellipj(u, mp)
//     ret = abs(ineps - s / c)
//     return ret
// 
// 
// func _kratio(m, k_ratio) {
//     m = float(m)
//     if m < 0:
//         m = 0.0
//     if m > 1:
...
// 
// 
// func _bessel_poly(n, reverse=False) {
//     /*
...
// 
// 
// func _aberth(f, fp, x0, tol=1e-15, maxiter=50) {
//     /*
...
// 
// 
// func _design_notch_peak_filter(w0, Q, ftype) {
//     /*
